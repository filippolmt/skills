...
A **vendored copy** in `.agents/skills/` is byte-identical to its upstream at the
...
This directory is empty on purpose: the pilot vendors five skills that need no
adaptation, and an overlay that is not needed is a fork waiting to happen.
